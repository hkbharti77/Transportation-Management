...
This system implements a comprehensive role-based access control system with distinct views for different user types:
...
- **Public Service Manager**: Public transport management with route scheduling and ticketing
- **Staff**: Limited access for operational support tasks

For implementation details, see [ENHANCED_ROLE_BASED_ACCESS_CONTROL.md](ENHANCED_ROLE_BASED_ACCESS_CONTROL.md)
