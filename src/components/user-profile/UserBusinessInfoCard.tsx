...
export default function UserBusinessInfoCard() {
  ...
  const handleOpenModal = () => {
    if (userProfile) {
      setFormData({
        ...
        business_license_number: userProfile.business_license_number || "",
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const updateData: Partial<UpdateBusinessData> = {};
      Object.keys(formData).forEach(key => {
        const value = formData[key as keyof UpdateBusinessData];
        if (value !== undefined && value !== null) {
          updateData[key as keyof UpdateBusinessData] = value;
        }
      });
      ...
      setUpdateError((error as Error).message || 'Failed to update business information. Please try again.');
    } finally {
      setIsUpdating(false);
    }
  };
      ...
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        <div className="flex items-center justify-center py-8">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Loading business information...</p>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        <div className="text-center py-8">
          <p className="text-sm text-gray-500 dark:text-gray-400">No business information available.</p>
        </div>
      </div>
    );
  }
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                  {userProfile.company_city_state || "-"}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                  {userProfile.company_postal_code || "-"}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                  {userProfile.business_license_number || "-"}
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div className="col-span-2">
                    ...
                    <Input 
                      ...
                      defaultValue={formData.business_license_number}
                      onChange={handleInputChange}
                    />
                  </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <Input 
                      type="tel" 
                      name="business_phone"
                      defaultValue={formData.business_phone}
                      onChange={handleInputChange}
                    />
                  </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <Input 
                      type="email" 
                      name="business_email"
                      defaultValue={formData.business_email}
                      onChange={handleInputChange}
                    />
                  </div>
                </div>
