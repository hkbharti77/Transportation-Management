...
const adminSidebar: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      { name: "Dashboard", path: "/admin/performance/dashboard", pro: false },
      { name: "Driver Scorecard", path: "/admin/performance/scorecard", pro: false },
      { name: "Behavior & Maintenance", path: "/admin/performance/events", pro: false },
      { name: "Unresolved Events", path: "/admin/performance/unresolved-events", pro: false },
      { name: "Vehicle Diagnostics", path: "/admin/performance/diagnostics", pro: false },
      { name: "Maintenance Alerts", path: "/admin/performance/maintenance", pro: false },
      { name: "API Test", path: "/admin/performance/test", pro: false, new: true },
    ],
  }
]
...
// ======================= Dispatcher Sidebar =======================
const dispatcherSidebar: NavItem[] = [
  {
    icon: <GridIcon />,
    name: "Dashboard",
...
// ======================= Public Service Manager Sidebar =======================
const publicServiceManagerSidebar: NavItem[] = [
  {
    icon: <GridIcon />,
    name: "Dashboard",
    path: "/dashboard",
  ...
  },
  {
    ...
    subItems: [
      { name: "All Tickets", path: "/public-services/tickets", pro: false },
      { name: "Admin Tickets", path: "/public-services/admin/tickets", pro: false },
      { name: "Search Tickets", path: "/public-services/tickets/search", pro: false },
      { name: "User Tickets", path: "/public-services/tickets/user", pro: false },
      { name: "Book Ticket", path: "/public-services/tickets/book", pro: false },
    ],
  },
  {
    icon: <UserCircleIcon />,
...
const getUserRole = (pathname: string, userRole?: string): UserRole => {
  ...
  if (pathname.startsWith("/dispatcher") || pathname === "/dispatcher-home") return "dispatcher";
  if (pathname.startsWith("/public-services") || pathname === "/public-service-manager") return "public_service_manager";
  if (pathname.startsWith("/staff") || pathname === "/staff-dashboard") return "staff";
...
const getSidebarItems = (role: UserRole): NavItem[] => {
  ...
  switch (role) {
    ...
    case "public_service_manager":
      return publicServiceManagerSidebar;
    case "staff":
      return staffSidebar;
    default:
      return adminSidebar;
