...
describe('BookingService', () => {
  ...
  describe('getBookingsByUserId', () => {
    it('should fetch bookings for a specific user with pagination', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        'http://127.0.0.1:8000/api/v1/bookings/user/3?skip=0&limit=100',
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
    ...
    it('should handle pagination parameters correctly', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        'http://127.0.0.1:8000/api/v1/bookings/user/3?skip=50&limit=25',
        expect.any(Object)
      );
    });
  ...
  describe('updateBookingStatus (new format)', () => {
    it('should update booking status with request body', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        'http://127.0.0.1:8000/api/v1/bookings/16/status',
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
  ...
  describe('cancelBooking (DELETE method)', () => {
    it('should cancel booking using DELETE method', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        'http://127.0.0.1:8000/api/v1/bookings/16/cancel',
        {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json',
  ...
  describe('getBookingsByStatus (new format)', () => {
    it('should fetch bookings by status with pagination', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        'http://127.0.0.1:8000/api/v1/bookings/status/confirmed?skip=0&limit=100',
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
    ...
    it('should handle pagination parameters correctly', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        'http://127.0.0.1:8000/api/v1/bookings/status/pending?skip=50&limit=25',
        expect.any(Object)
      );
    });
  });
  ...
  describe('confirmBooking', () => {
    it('should confirm a booking successfully', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        'http://127.0.0.1:8000/api/v1/bookings/16/confirm',
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
  ...
  describe('completeBooking', () => {
    it('should complete a booking successfully', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        'http://127.0.0.1:8000/api/v1/bookings/17/complete',
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
    ...
    it('should fetch booking with dispatch information', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        'http://127.0.0.1:8000/api/v1/bookings/16/with-dispatch',
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
  ...
  describe('getBookingById', () => {
    it('should fetch a single booking by ID', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        'http://127.0.0.1:8000/api/v1/bookings/16',
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
  ...
  describe('getUserBookings', () => {
    it('should fetch current user bookings', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        'http://127.0.0.1:8000/api/v1/bookings/me',
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
  ...
  describe('getBookingAnalytics', () => {
    it('should fetch booking analytics data', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        'http://127.0.0.1:8000/api/v1/bookings/analytics',
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
    ...
    it('should fetch booking analytics with date parameters', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        `http://127.0.0.1:8000/api/v1/bookings/analytics?start_date=${encodeURIComponent(startDate)}&end_date=${encodeURIComponent(endDate)}`,
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
  ...
  describe('getBookingRevenue', () => {
    it('should fetch booking revenue data successfully', () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        'http://127.0.0.1:8000/api/v1/bookings/revenue',
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
    ...
    it('should fetch booking revenue data with date range', () => {
      ...
      expect(fetch).toHaveBeenCalledWith(
        'http://127.0.0.1:8000/api/v1/bookings/revenue?start_date=2025-08-01T00%3A00%3A00.000Z&end_date=2025-08-31T23%3A59%3A59.999Z',
        {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
