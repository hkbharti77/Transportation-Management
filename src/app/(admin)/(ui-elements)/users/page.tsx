...
export default function UsersPage() {
  ...
  useEffect(() => {
    // Fetch users from API with server-side pagination and filtering
  ...
  // Reset to page 1 when search or filters change (but not when page changes)
  useEffect(() => {
    if (currentPage !== 1) {
      setCurrentPage(1);
    }
  ...
  // Since we're using server-side pagination, the filteredUsers already contains the current page data
          ...
          <div className="flex items-center">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-yellow-700 dark:text-yellow-300 mt-1">
                Unable to connect to the backend API. Please ensure your backend server is running on http://127.0.0.1:8000
              </p>
            </div>
            <div className="ml-4">
              <input
